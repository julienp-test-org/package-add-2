...
class BytesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] length: The number of bytes requested. The minimum value for length is 1.
...
class Bytes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            hex: Optional[pulumi.Input[_builtins.str]] = None,
            keepers: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            length: Optional[pulumi.Input[_builtins.float]] = None) -> 'Bytes':
        """
